...
class FaceRecognition:
    ...
    def face_encoding_list(self, known_data_dir):
        ...
        for img in os.listdir(known_data_dir):
            try:
                img_file_path = os.path.join(known_data_dir, img)
                known_image = face_recognition.load_image_file(img_file_path)
                ...
                print("Known image", img_file_path)
    ...
    def nid_verification(self, upload_image, display=False):
